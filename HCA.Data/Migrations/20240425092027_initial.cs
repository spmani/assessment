        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModifiedDate = table.Column<DateTime>(type: "TEXT", nullable: true),
                    Modifiedby = table.Column<string>(type: "TEXT", nullable: true),
                    Emailtriggered = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "senthil.prabhu@altrockstech.com", "Senthil Prabhu" },
                    { 2, "bharath.p@altrockstech.com", "Altrocks" },
                    { 3, "bharath.p@altrockstech.com", "Adithya" },
                    { 4, "bharath.p@altrockstech.com", "Vishnu" },
                    { 5, "bharath.p@altrockstech.com", "Sasi" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 4, 25, 14, 50, 27, 147, DateTimeKind.Local).AddTicks(3447), "System", true, null, null, "Pending" },
                    { 2, new DateTime(2024, 4, 25, 14, 50, 27, 147, DateTimeKind.Local).AddTicks(3502), "System", true, null, null, "Completed" }
                });
